...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<cookiejar>.freeze, [">= 0.3.0".freeze])
  s.add_runtime_dependency(%q<em-http-request>.freeze, [">= 1.1.6".freeze])
  ...
  s.add_runtime_dependency(%q<multi_json>.freeze, [">= 1.0.0".freeze])
  s.add_runtime_dependency(%q<rack>.freeze, [">= 1.0.0".freeze])
  s.add_runtime_dependency(%q<websocket-driver>.freeze, [">= 0.5.1".freeze])
  s.add_development_dependency(%q<compass>.freeze, ["~> 0.11.0".freeze])
  s.add_development_dependency(%q<haml>.freeze, ["~> 3.1.0".freeze])
  s.add_development_dependency(%q<permessage_deflate>.freeze, [">= 0.1.0".freeze])
  s.add_development_dependency(%q<puma>.freeze, [">= 2.0.0".freeze])
  s.add_development_dependency(%q<rack-proxy>.freeze, ["~> 0.4.0".freeze])
  s.add_development_dependency(%q<rack-test>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<rake>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<RedCloth>.freeze, ["~> 3.0.0".freeze])
  ...
  s.add_development_dependency(%q<sass>.freeze, ["~> 3.2.0".freeze])
  s.add_development_dependency(%q<sinatra>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<staticmatic>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<rainbows>.freeze, ["~> 4.4.0".freeze])
  s.add_development_dependency(%q<thin>.freeze, [">= 1.2.0".freeze])
